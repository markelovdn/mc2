<?php $this->layout('template/users_header', ['title' => 'Создать пользователя']) ?>
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form method="post" action="/addGeneralInfo" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
...
<!--                                <input type="text" id="simpleinput" name="id" class="form-control">-->
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" name="mobile" class="form-control">
                                </div>

                                <!-- address -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Адрес</label>
                                    <input type="text" id="simpleinput" name="adres" class="form-control">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="example-select" name="status">
                                        <option value="6">Онлайн</option>
                                        <option value="7">Отошел</option>
                                        <option value="8">Не беспокоить</option>
                                    </select>
                                </div>
